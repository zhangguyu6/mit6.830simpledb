...
public class Tuple implements Serializable {
    ...
    public static Tuple merge(Tuple t1,Tuple t2){
        ...
        for (int i =0;i<t1.getFields().length;i++){
            newt.setField(i,t1.getField(i));
        }
        for (int i= 0;i<t2.getFields().length;i++){
            newt.setField(i+t1.getFields().length,t2.getField(i));
        }
        return newt;
    }
}
